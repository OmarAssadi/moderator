...
function COMMAND:OnRun(client, arguments, target)
    ...
    if (not weapons.Get(class) and not hl2Weapons[class] and class ~= "weapon_physgun") then
        class = class:lower()
        if (not weapons.Get(class) and not hl2Weapons[class] and class ~= "weapon_physgun") then return false, "you provided an invalid weapon class." end
    end
